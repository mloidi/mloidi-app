...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    if (isHearted) {
      _this.heart.classList.toggle('heart__button--float');
      setTimeout(function () {
        return _this.heart.classList.toggle('heart__button--float');
      }, 2500);
    }
  }).catch(console.error);
}
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    // then zoom the map to fill all the markers perfectly
